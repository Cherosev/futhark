...
-- ==
-- entry: rev fwd
-- compiled input @ histo-mul-data1.txt
-- output @ histo-mul-data1Res.txt
-- compiled input @ histo-mul-data2.txt
-- output @ histo-mul-data2Res.txt
-- compiled input @ histo-mul-data3.txt
-- output @ histo-mul-data3Res.txt
